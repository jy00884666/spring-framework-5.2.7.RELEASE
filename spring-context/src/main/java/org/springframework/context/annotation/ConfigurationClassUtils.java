...
abstract class ConfigurationClassUtils {
	 ...
	 * 检查给定的bean定义是否是配置类的候选者 (或在配置/组件类中声明的嵌套组件类，为自动注册)，并相应地标记它。
	...
	public static boolean checkConfigurationClassCandidate(
		...
		// 存在@Configuration. 并且proxyBeanMethods 不为false (为true或为null)时,就是Full配置类
